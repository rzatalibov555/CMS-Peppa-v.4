...
INSERT INTO `items` (`id`, `url`, `title`, `title_en`, `title_ru`, `title_tr`, `description`, `description_en`, `description_ru`, `description_tr`, `rank`, `date`, `img`, `status`, `creater_id`, `creat_date`, `updater_id`, `update_date`) VALUES
(1, 'apple', 'apple store', '', '', '', 'It is a apple store', NULL, NULL, NULL, '1', NULL, '', '1', 5, '11', 11, '11'),
(2, 'apple1', 'apple store1', '', '', '', 'It is a apple store1', NULL, NULL, NULL, '1', NULL, '', '0', 5, '12', 12, '12'),
(3, 'apple3', 'apple store3', '', '', '', 'It is a apple store3', NULL, NULL, NULL, '1', NULL, '', '1', 5, '13', 13, '13');
